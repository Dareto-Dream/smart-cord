...
public sealed class AppState
{
    ...
    /// <summary>Streaming / do-not-disturb one-click preset, active across restarts.</summary>
    public bool StreamingMode { get; set; }

    /// <summary>When the weekly recap toast last fired, so it only shows once a week.</summary>
    public DateTime? LastWeeklyRecapShown { get; set; }
}
