...
public sealed class SmartCordController : IDisposable
{
    ...
    private Task RefreshPresenceAsync()
    {
        ...
        if (_manualPreset is null && _codingDrivesPresence && _integrations.Current is { } snapshot)
        {
    ...
    private PresencePayload BuildCodingPayload(CodingSnapshot snapshot)
    {
        ...
        var dashboardUrl = snapshot.Source == "WakaTime"
